...
export const UPGRADES: UpgradeDef[] = [
  ...
  { id: 'axiomKiss', key: 'axiomKiss', kind: 'tap', icon: '◇', rarity: 'legendary', baseCost: 20_000, growth: 1.275, amount: 220, unlockLevel: 4 },
  ...
  { id: 'voidFlow', key: 'voidFlow', kind: 'auto', icon: 'V', rarity: 'epic', baseCost: 30_000, growth: 1.255, amount: 165, unlockLevel: 3 },
  { id: 'flowEngine', key: 'flowEngine', kind: 'auto', icon: 'X', rarity: 'legendary', baseCost: 180_000, growth: 1.28, amount: 950, unlockLevel: 5 },
];
