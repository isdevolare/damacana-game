...
export type PlanetThemeEffect = 'calm' | 'dust' | 'rings' | 'iceFog' | 'storm';
...
export const FUTURE_ARC_THEME_HOOKS: Record<Exclude<ArcId, 'planet'>, FutureArcThemeHook> = {
  star: {
    id: 'star',
    accent: '#ffd166',
    ambientGlow: 'rgba(255,209,102,0.5)',
    backgroundHint: 'stellar flare fields and heat bloom',
  },
  galaxy: {
    id: 'galaxy',
    accent: '#ff5ce8',
