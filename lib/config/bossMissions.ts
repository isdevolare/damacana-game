...
const CHAPTER_PROFILES: Record<ChapterId, ChapterCombatProfile> = {
  ...
  redDwarf: {
    ...
    enemyDamage: [1.08, 1.34],
    pulseDamage: [1.08, 1.48],
    summonCount: [3, 5],
  },
  whiteDwarf: {
    hpMult: 1.86,
    ...
    enemyDamage: [1.16, 1.42],
    pulseDamage: [1.18, 1.54],
    summonCount: [3, 5],
  },
  giantStar: {
    hpMult: 2.18,
    ...
    enemyDamage: [1.22, 1.52],
    pulseDamage: [1.26, 1.64],
    summonCount: [3, 5],
  },
  supernova: {
    hpMult: 2.55,
