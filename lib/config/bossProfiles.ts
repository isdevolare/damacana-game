...
const BOSS_PROFILES: Record<ChapterId, BossProfile> = {
  ...
  giantStar: {
    ...
    orbitSweep: { intervalMs: 9200, warningMs: 980, speed: 0.036, damageMult: 1 },
    weakPointTiming: { minMs: 5400, maxMs: 9000, durationMult: 0.82 },
    pulseIntervalMult: 0.9,
    summonIntervalMult: 0.88,
  ...
  supernova: {
    id: 'supernova',
    i18nKey: 'supernova',
    rage: { hpThreshold: 0.5, durationMs: 11500, pulseIntervalMult: 0.78, summonIntervalMult: 0.78 },
    rotatingWeakPoint: { speed: 2.2, radiusPx: 34 },
    shieldWindow: { intervalMs: 11800, durationMs: 1900, damageTakenMult: 0.48 },
    corruptedPulse: { chance: 0.32, damageMult: 1.45, speedMult: 1.12 },
