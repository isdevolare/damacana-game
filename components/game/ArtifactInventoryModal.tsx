      ...
      {show && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            className="max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-hidden rounded-xl border border-gold/35 bg-black/92 shadow-[0_0_36px_rgba(255,209,102,0.12)]"
          ...
          >
            ...
            <div className="max-h-[66dvh] space-y-2 overflow-y-auto p-3">
              {owned.length === 0 && (
